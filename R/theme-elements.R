...
#' panel.background.tern plot.background.tern axis.tern.clockwise axis.tern.padding axis.tern 
...
#' panel.margin.tern panel.tern.expand
...
##TERNARY PANEL
ggint$.element_tree$panel.background.tern  = .el_def("element_rect", "panel.background",     description="Background of Ternary Clipping Area**")
ggint$.element_tree$plot.background.tern   = .el_def("element_rect", "plot.background",      description="Background of Ternary Plot Area**")
...
ggint$.element_tree$axis.tern.arrowsep       = .el_def("numeric",                              description="Arrows Seperation from Axis")
...
ggint$.element_tree$panel.tern.expand        = .el_def("numeric",                              description="The amount to expand the ternary plotting panel, in ratio to npc units")
ggint$.element_tree$panel.tern.rotate        = .el_def("numeric",                              description="The amount to rotate the ternary diagram in degrees")
ggint$.element_tree$panel.grid.tern.ontop    = .el_def("logical",                              description="The amount to expand the ternary plotting panel, in ratio to npc units")
