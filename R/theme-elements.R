...
#' tern.panel.background tern.plot.background tern.axis.clockwise tern.axis.padding tern.axis 
...
#' tern.axis.showarrows tern.axis.arrowsep tern.axis.arrowstart tern.axis.arrowfinish 
#' tern.axis.arrow tern.axis.arrow.T tern.axis.arrow.L tern.axis.arrow.R tern.axis.arrow.text 
#' tern.axis.arrow.text.T tern.axis.arrow.text.L tern.axis.arrow.text.R tern.axis.showtitles
#' tern.axis.title tern.axis.title.T tern.axis.title.L tern.axis.title.R tern.axis.ticklength.major 
#' tern.axis.ticklength.minor tern.axis.ticks.outside tern.axis.ticks.showprimary tern.axis.ticks.showsecondary 
#' tern.axis.ticks tern.axis.ticks.major tern.axis.ticks.major.T tern.axis.ticks.major.L tern.axis.ticks.major.R 
#' tern.axis.ticks.minor tern.axis.ticks.minor.T tern.axis.ticks.minor.L tern.axis.ticks.minor.R tern.axis.showgrid.major 
#' tern.panel.grid tern.panel.grid.major tern.panel.grid.major.T tern.panel.grid.major.L tern.panel.grid.major.R 
#' tern.axis.showgrid.minor tern.panel.grid.minor 
...
ggint$.element_tree$tern.axis.padding        = .el_def("unit",                                 description="Padding between ternary plot and perimeter")
...
ggint$.element_tree$tern.axis.showlabels     = .el_def("logical",                              description="Axis Labels Show or Hide")
...
ggint$.element_tree$tern.axis.showarrows     = .el_def("logical",                              description="Arrows Show or Hide")
ggint$.element_tree$tern.axis.arrowsep       = .el_def("numeric",                              description="Arrows Seperation from Axis")
ggint$.element_tree$tern.axis.arrowstart     = .el_def("numeric",                              description="Proportion of Axis when Arrow Starts")
ggint$.element_tree$tern.axis.arrowfinish    = .el_def("numeric",                              description="Proportion of Axis when Arrow Finishes")
...
ggint$.element_tree$tern.axis.showtitles     = .el_def("logical",                              description="Apex Titles Show or Hide")
...
ggint$.element_tree$tern.axis.ticklength.major    = .el_def("unit",                            description="Ticks Major Ticklength")
ggint$.element_tree$tern.axis.ticklength.minor    = .el_def("unit",                            description="Ticks Minor Ticklength")
ggint$.element_tree$tern.axis.ticks.outside  = .el_def("logical",                              description="Ticks Outside or Inside") #
ggint$.element_tree$tern.axis.ticks.showprimary   = .el_def("logical",                         description="Ticks Show Primary")
ggint$.element_tree$tern.axis.ticks.showsecondary = .el_def("logical",                         description="Ticks Show Secondary")
...
ggint$.element_tree$tern.axis.showgrid.major = .el_def("logical",                              description="Show or Hide Major Gridline")
...
ggint$.element_tree$tern.axis.showgrid.minor = .el_def("logical",                              description="Show or Hide Minor Gridline")
